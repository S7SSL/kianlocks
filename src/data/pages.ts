...
export const PAGES: PageEntry[] = [
  ...
  {
    path: '/guides/how-to-measure-a-euro-cylinder/',
    kind: 'guide',
    title: 'How to Measure a Euro Cylinder Lock',
    h1: 'How to measure a euro cylinder lock (and why size matters)',
    description: 'Measure a euro cylinder in two minutes: from the centre of the fixing screw to each end, written like 35/45 — and why one that sticks out is easier to snap.',
    summary: 'Step-by-step euro cylinder measuring, how sizes are written, and the 3mm protrusion rule.',
    published: '2026-09-23',
    updated: '2026-09-23',
  },
  {
    ...
    description: 'Change locks between tenancies in London and Hertfordshire: Avocet ABS 3-star cylinder, 3 keys and an itemised invoice for your records. £149 flat per door.',
  ...
  },
  {
    ...
    description: 'Upgrade your euro cylinder to an Avocet ABS (TS007 3-star, Sold Secure Diamond) in London and Herts. £149 fitted with 3 keys and an itemised invoice.',
  ...
  },
  {
    ...
    kind: 'landing',
    title: 'Emergency Locksmith London & Herts — 24/7',
